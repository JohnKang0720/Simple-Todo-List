...
function Todoform() {
    const {input, addTask, removeTask, clearTask, editTask} = useContext(taskContext)
    ...
    return (
       ...
       <form onSubmit = {handleSubmit}> 
        ...
        <ul>
            ...
            <List task = {task} key = {task.id} remove = {removeTask} length = {input.length} edit = {editTask}/>
